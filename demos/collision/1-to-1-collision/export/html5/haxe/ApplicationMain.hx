...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("1-to-1-collision", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("1-to-1-collision", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "1-to-1-collision";
		app.meta["name"] = "1-to-1-collision";
