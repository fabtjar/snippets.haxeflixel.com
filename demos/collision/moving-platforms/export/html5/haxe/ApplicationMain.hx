...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("moving-platforms", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("moving-platforms", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "moving-platforms";
		app.meta["name"] = "moving-platforms";
