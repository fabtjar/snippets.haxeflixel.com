...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("tilemap-collision", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("tilemap-collision", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "tilemap-collision";
		app.meta["name"] = "tilemap-collision";
