...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("angular-acceleration", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("angular-acceleration", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "angular-acceleration";
		app.meta["name"] = "angular-acceleration";
