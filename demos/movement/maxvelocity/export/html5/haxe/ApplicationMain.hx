...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("maxvelocity", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("maxvelocity", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "maxvelocity";
		app.meta["name"] = "maxvelocity";
