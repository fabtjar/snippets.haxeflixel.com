...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("acceleration", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("acceleration", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "acceleration";
		app.meta["name"] = "acceleration";
