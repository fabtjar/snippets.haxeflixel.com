...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("angular-velocity", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("angular-velocity", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "angular-velocity";
		app.meta["name"] = "angular-velocity";
