...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("typed-group", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("typed-group", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "typed-group";
		app.meta["name"] = "typed-group";
