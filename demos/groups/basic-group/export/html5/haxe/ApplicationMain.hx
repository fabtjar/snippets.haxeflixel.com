...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("basic-group", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("basic-group", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "basic-group";
		app.meta["name"] = "basic-group";
