...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("overlap-callbacks", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("overlap-callbacks", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "overlap-callbacks";
		app.meta["name"] = "overlap-callbacks";
