...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("simple-overlap", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("simple-overlap", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "simple-overlap";
		app.meta["name"] = "simple-overlap";
