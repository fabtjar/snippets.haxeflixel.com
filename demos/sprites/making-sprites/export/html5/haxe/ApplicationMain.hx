...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("making-sprites", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("making-sprites", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "making-sprites";
		app.meta["name"] = "making-sprites";
