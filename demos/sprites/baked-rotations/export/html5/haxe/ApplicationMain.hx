...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("baked-rotations", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("baked-rotations", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "baked-rotations";
		app.meta["name"] = "baked-rotations";
