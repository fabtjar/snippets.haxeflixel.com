...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("loading-sprites", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("loading-sprites", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "loading-sprites";
		app.meta["name"] = "loading-sprites";
