...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("flxbitmaptext", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("flxbitmaptext", null, 320, 240);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "flxbitmaptext";
		app.meta["name"] = "flxbitmaptext";
