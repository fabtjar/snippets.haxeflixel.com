...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("title-logo", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("title-logo", null, 725, 85);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "title-logo";
		app.meta["name"] = "title-logo";
